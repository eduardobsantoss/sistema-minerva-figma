...
import { brl, UF_OPTIONS, PAISES_DDI, type ContratoAtivo, type ParcelaAtivo } from '../../data/operacaoData';
...
const emit = defineEmits<{ close: []; create: [data: ContratoAtivo] }>();
    ...
    >
      ...
      <div style="flex: 1; overflow-y: auto; padding: 32px">
        <div class="flex flex-col" style="gap: 24px">
          <ToggleRow label="Gerar minuta" :on="form.gerarMinuta" @toggle="form.gerarMinuta = !form.gerarMinuta" />
