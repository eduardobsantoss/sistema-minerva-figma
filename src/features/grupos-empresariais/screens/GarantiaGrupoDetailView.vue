...
import { StepGrid } from '@/features/solicitacao-operacao/components/modals/adicionar-contrato';
import {
...
import GarantiaSection from './garantia-detail/GarantiaSection.vue';
...
<template>
  <div class="flex flex-col" style="gap: 24px">
    ...
    <div
      ...
      "
    >
      <div v-if="tab === 'dados'" class="flex flex-col" style="gap: 32px">
        <GarantiaSection title="Dados da garantia" :icon="Scale">
        <StepGrid>
        ...
        <GarantiaSection v-if="showCamposPadrao && g.constituirGarantia" title="Constituição da garantia" :icon="Scale">
        <StepGrid>
        ...
        <GarantiaSection v-if="isGarantiaEstoque(g.tipo)" title="Informações do estoque de formação" :icon="Scale">
        <StepGrid>
        ...
        <GarantiaSection v-if="isGarantiaEstoque(g.tipo)" title="Listagem de Estoque" :icon="Scale">
          <EstoqueListPanel :items="g.estoques ?? []" @update="updateEstoques" />
        </GarantiaSection>

        <GarantiaSection v-if="isGarantiaImovel(g.tipo)" title="AF. Imóvel" :icon="Scale">
        <StepGrid>
        ...
        <GarantiaSection
          v-if="isGarantiaCessaoDuplicatas(g.tipo) || isGarantiaCessaoContrato(g.tipo)"
          title="Cessão fiduciária"
          :icon="Scale"
        >
        <StepGrid>
        ...
        <GarantiaSection title="Situação operacional" :icon="ShieldCheck">
        <StepGrid>
